#ifndef COIN_BIEVR_ROS_COMMON_PUBLISHER_BASE_H_
#define COIN_BIEVR_ROS_COMMON_PUBLISHER_BASE_H_
...
class PublisherBase {
 public:
  ...
  // under that namespace (e.g. ns="coin_bievr" turns "odometry" into
...
#endif  // COIN_BIEVR_ROS_COMMON_PUBLISHER_BASE_H_
