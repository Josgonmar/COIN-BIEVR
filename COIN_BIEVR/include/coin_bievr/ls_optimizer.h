#ifndef COIN_BIEVR_LS_OPTIMIZER_H_
...
struct RegistrationConfig {
  ...
  double photometric_weight = 0.00095;
};

inline bool getSubPixelValue(const Eigen::MatrixXf& image, const Eigen::MatrixXf& weights,
...
inline bool sampleValueAndGradient(const Eigen::MatrixXf& image, const Eigen::MatrixXf& weights,
...
class LsqRegistration {
 public:
  ...
  LsqRegistration(const COINBIEVRMap& map, const Pointcloud& geometric_source,
...
#endif  // COIN_BIEVR_LS_OPTIMIZER_H_
